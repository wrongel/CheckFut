...
//
///////////////////////////////////////////////////////////////////////////////
// 17.10.2017    - Исправления Бычкова Р.О. (БРО)
//				   Возможность добавления кнопки в элемент списка путем передачи в SetColumnHeader дополнительного флага
//				   Измените обработчик, если требуется
//				   Отменить исправления - закомментровать define BRO
///////////////////////////////////////////////////////////////////////////////
// 24.09.2019    - Исправления Бычкова Р.О. (БРО)
//				   Изменил маркер для форматирования заколовка с , на ! в SetColumnHeader
///////////////////////////////////////////////////////////////////////////////
...
#ifdef BRO
#define IDC_BUT_CHANGEFOL 2000			// Идентификатор для кнопки выбора файла
#endif
//////////////////////////////////////////////////////////////////////////////////
...
#ifdef BRO
	// Привязка объекта ReportCtrl к листу, созданному на форме
	BOOL AssignList(CWnd* pParentWnd, UINT nID, CFont *pFont = NULL);
	void CheckBoxEnable(int nEnableFlag);		// Включение, отключение изображения чекбокса в шапке. Добавлено 05.04.2019
#endif
//////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////// БРОПРАВКА 17.10.2017 //////////////////////////////
	...
	CList<int> m_ListButtHead;	// Список индексов столбцов с кнопками
	CButton m_ButChangeFol;		// Кнопка смены папки
	int m_nCheckEnable;			// Флаг доступности чекбоксов, введен 05.04.2019
...
/////////////////////////////// БРОПРАВКА 17.10.2017 //////////////////////////////
	...
	// Объявление обработчика кнопки смены папки
